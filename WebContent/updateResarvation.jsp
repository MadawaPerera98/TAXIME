                        ...
                        <div class="p-5">
                           ...
                           <form class="user" action="updateReservation" method="post">
                                ...
                                %>
                                    ...
                                    <input class="form-control form-control-user" value="<%=resarvation.getPickupLocation() %>" type="search" id="pick" placeholder="Pickup Location" name="pick_location" style="border-radius: 0px;" required="required"></div>
                                   
                                    <div class="col-sm-6">
                                    <input class="form-control form-control-user"  value="<%=resarvation.getDropLocation() %>" type="search" id="drop" placeholder="Drop Location" name="drop_location" style="border-radius: 0px;" required="required"></div>
                                ...
                                <div class="row mb-3">
                                 ...
                                 <div class="row mb-3" >
                                    ...
                                    %>
                                    <input class="form-control form-control-user" type="text" id="exampleFirstName-1"  autocomplete="off" placeholder="Vehicle Number" name="VNumber"  value="<%=resarvation.getVehicleId()%>" style="border-radius: 0px; margin-bottom: 15px;"  list="numberList" required="required" >
                                   ...
                                   <div class="col-sm-6 mb-3 mb-sm-0">
                                      ...
                                      if(user.getUserType().equals("employee")){
                                    %>
                                    <input class="form-control form-control-user" type="text" autocomplete="off" id="exampleFirstName-1" value="<%=resarvation.getUserId() %>" placeholder="Customer Name" name="cusName" style="border-radius: 0px; margin-bottom: 15px;"  list="userName" required="required">
								    ...
								    <input type="hidden" name="oldvehicle" value="<%=resarvation.getVehicleId() %>" >
                                    </div>
