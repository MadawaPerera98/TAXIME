                            ...
                            <form class="user" action="addReservation" method="post">
                                ...
                                <div class="row mb-3">
                                 ...
                                 <div class="row mb-3" >
                                    ...
                                    %>
                                    <input class="form-control form-control-user" type="text" id="exampleFirstName-1" autocomplete="off" placeholder="Vehicle Number" name="VNumber" style="border-radius: 0px; margin-bottom: 15px;"  list="numberList" required="required">
                                   ...
                                   <div class="col-sm-6 mb-3 mb-sm-0">
                                      ...
                                      if(user.getUserType().equals("employee")){
                                    %>
                                    <input class="form-control form-control-user" type="text"autocomplete="off" id="exampleFirstName-1" placeholder="Customer Name" name="cusName" style="border-radius: 0px; margin-bottom: 15px;"  list="userName" required="required">
                                                ...
                                                <div>
                                                    <div class="row">
                                                      ...
                                                      <%} %>
                                                        ...
                                                        <a href="deleteReservation?id=<%=resarvation.getId() %>&vid=<%=resarvation.getVehicleId() %>" class="btn btn-danger btn-circle ms-1" role="button"><i class="fas fa-trash text-white"></i></a></div>
                                                    </div>
                                                </div>
                                            </td>
